        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineerWorkStatus = table.Column<bool>(nullable: false),
                    EngineerHireDate = table.Column<DateTime>(nullable: false),
                    EngineerNextCertificationDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineOnlineStatus = table.Column<bool>(nullable: false),
                    MachineInstallDate = table.Column<DateTime>(nullable: false),
                    MachineNextInspectionDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
